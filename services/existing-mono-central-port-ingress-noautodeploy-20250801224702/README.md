# existing-mono-central-port-ingress-noautodeploy-20250801224702
...
```
docker build -t existing-mono-central-port-ingress-noautodeploy-20250801224702:latest .
docker run -p:5030:9999 existing-mono-central-port-ingress-noautodeploy-20250801224702:latest
```
